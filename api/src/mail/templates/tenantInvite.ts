export const tenantInvite = `<mjml>
  <mj-head>
    ...
    <mj-wrapper padding-top="0" padding-bottom="0" css-class="body-section">
      <mj-section border-radius="0 0 20px 20px" background-color="#292929" padding-left="15px" padding-right="15px">
        <mj-column width="100%">
          ...
          <mj-text color="#e6e6e6" font-size="16px">
		  	If you want to accept the invite, simply press the "Accept invitation" button down below. If you think you have been invited by accident you can safely ignore this email.
          </mj-text>
          <mj-button border-radius="50px" background-color="#FF926B" align="center" color="#ffffff" font-size="17px" font-weight="bold" href="{{ config.frontendBaseUrl }}/onboarding/tenant-invite/{{ invite.uuid }}" width="300px">
            Accept invitation
          </mj-button>
        </mj-column>
      </mj-section>
